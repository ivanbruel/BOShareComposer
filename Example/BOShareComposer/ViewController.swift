...
class ViewController: UIViewController {
  ...
  lazy var shareContentWithMetaData: ShareContent = {
    return ShareContent(
      ...
      link: URL(string: "https://medium.com/@samvlu/100-days-of-swift-736d45a19b63#.a1llu43fd")!
    )
  }()
  ...
  lazy var shareContentWithoutMetaData: ShareContent = {
    return ShareContent(
      ...
      link: URL(string: "https://news.ycombinator.com/")!
    )
  }()

  lazy var shareOptions: ShareOptions = {
    return ShareOptions(tintColor: UIColor.red, title: "Custom long text title that does not fit", dismissText: "Dismiss",
                        confirmText: "Confirm", showMetadata: true)
  }()

  lazy var shareOptionsNoMetadata: ShareOptions = {
    return ShareOptions(tintColor: UIColor.red, title: "Custom title", dismissText: "Dismiss",
